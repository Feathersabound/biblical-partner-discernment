function homeView() {
  ...
  return "<div class=\"card\">" +
    ...
    "<p class=\"note\">If you are not safe, get safe first. Do not use this app to stay in harm.</p>" +
    "<div class=\"grid two\">" +
    ...
    pathCard("Practice", "Do one small act", "Ask. Bless. Thank God. Make peace if it is safe.", done.has("practice")) +
